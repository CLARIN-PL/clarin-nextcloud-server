...
class MewexController extends Controller{
	private $userId;
	private $pathToShareMount = "/public-dspace/nextcloud/mewex/";
	...
	public function export(){
		...
		return new JSONResponse(["mewexPathToFile" => $this->pathToShareMount.$destFileName]);
	}
}